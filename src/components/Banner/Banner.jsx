    ...
    <div className="news-banner-wrapper">
      <div className="banner-container">
        <div className="banner-content">
          <a href="#">
            <span>ContentCon ‘25 registration is open! Register now</span>
            <span className="icon">
              <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                <rect width="24" height="24" rx="12" fill="white" />
                <path
                  d="M12.4599 16.4242L11.6688 15.6516L14.7594 12.561H7.125V11.4573H14.7594L11.6504 8.34832L12.4415 7.57568L16.8749 12.0091L12.4599 16.4242Z"
                  fill="#7C4DFF"
                />
              </svg>
            </span>
        ...
        <div className="banner-actions">
          {["Academy", "Marketplace", "Docs"].map((item) => (
            <Fragment key={item}>
              <a className="banner-action" href="#">
                {item}
              </a>
